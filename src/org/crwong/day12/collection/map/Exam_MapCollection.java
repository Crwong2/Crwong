package org.crwong.day12.collection.map;

import java.util.HashMap;
import java.util.Map;
import java.util.Scanner;

import org.crwong.day08.oop.objectarray.student.Student;
...
public class Exam_MapCollection {
	public static void main(String[] args) {
		 ...
		 * 3. extends Object
		 * 4. this
		 * 5. 기본생성자(업캐스팅), 상속시 super() 
		 * 6. return; <- void 쓸때 생략됨
		 * 7. java.lang패키지
		 * 
		 */
	...
	public void basicSample() {
		...
		map.put("02", "서울"); // map.put(Key, Value);
		map.put("031", "경기도");
		map.put("032", "인천");
		map.put("052", "부산");
		map.put("064", "제주도");
		System.out.println("저장된 데이터수 : " + map.size());
